...
- 支持把候选池筛成高精度 accepted dataset，演示 rejection sampling 路线
...
- 演示 chosen / rejected 对怎样变成最小偏好优化信号
- 演示 base checkpoint 与 aligned checkpoint 的 chosen win rate / preference margin 对照
- 演示 DPO / GRPO-like 训练如何接进 regression suite 和 summary board
